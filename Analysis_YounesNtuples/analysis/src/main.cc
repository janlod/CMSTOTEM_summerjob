...
//simpleCut("tree", "/eos/cms/store/group/phys_diffraction/CMSTotemLowPU2018/YounesNtuples/TOTEM20.root", "TOTEM20");
	...
	std::array<float, 3> gauss_guess = {1000, 500, 20};
	gaussfit_kaon_mass(inv_mass_TOTEM2, "TOTEM2", gauss_guess, "x");
	gaussfit_kaon_mass(inv_mass_TOTEM2, "TOTEM2", gauss_guess, "y");
	gaussfit_kaon_mass(inv_mass_TOTEM4, "TOTEM4", gauss_guess, "x");
	gaussfit_kaon_mass(inv_mass_TOTEM4, "TOTEM4", gauss_guess, "y");
